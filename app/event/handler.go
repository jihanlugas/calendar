...
// @Accept json
// @Produce json
// @Param req query request.PageEvent false "url query string"
...
func (h Handler) GetById(c echo.Context) error {
	...
	vEvent, err := h.usecase.GetById(loginUser, id, preloadSlice...)
	if err != nil {
		return response.Error(http.StatusBadRequest, err.Error(), err, nil).SendJSON(c)
	}
...
// @Accept json
// @Produce json
// @Param req body request.CreateEvent true "json req body"
// @Success      200  {object}	response.Response
// @Failure      500  {object}  response.Response
// @Router /event [post]
...
// @Produce json
// @Param id path string true "ID"
// @Param req body request.UpdateEvent true "json req body"
// @Success      200  {object}	response.Response
// @Failure      500  {object}  response.Response
// @Router /event/{id} [put]
